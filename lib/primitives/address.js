...
/**
 * Converts a bech32 address to base58 address.
 * @param {String} data
 * @param {Network?} network
 * @returns {Base58Address}
 * @throws Parse error.
...
Address.base58FromBech32 = function base58FromBech32(data, network) {
  return new Address().fromBech32(data, network).toBase58();
};

/**
 * Converts any bech32 address in an array to base58
 * @param {String[]} data
 * @returns {Base58Address[]}
 * @throws Parse error.
 */

Address.base58ifyAll = function base58ifyAll(addresses) {
  return addresses.map(function(address) {
    try {
      return Address.base58FromBech32(address);
    } catch (_err) {
      return address;
    }
  });
